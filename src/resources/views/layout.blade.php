...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/backpack/') }}/ionicons/ionicons.min.css">
    ...
    <link rel="stylesheet" href="{{ asset('fonts/gfont.css') }}">
...
<body class="hold-transition {{ config('backpack.base.skin') }} {{ (!isset($fullLayout) || (isset($fullLayout) && !$fullLayout))?'sidebar-mini':'' }} {{ isset($bodyClass)?$bodyClass:'' }}">

@if(!isset($fullLayout) || (isset($fullLayout) && !$fullLayout))
    ...
    <!-- ./wrapper -->
@elseif(isset($fullLayout) && $fullLayout)
    @yield('content')
@endif
